        ...
        <div className="grid grid-cols-1 gap-3 my-20 w-[90%] md:w-[75%]">
          ...
          <div className="w-[100%] bg-(--card-background) rounded-[15px] p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
              ...
              <Button onClick={() => navigate('archive/categories')} label="Fetch archived categories" icon={<FontAwesomeIcon icon={faDownload} />} width="auto" />
            </div>
          </div>
          ...
          <div className="w-[100%] bg-(--card-background) rounded-[15px] p-5">
            <h2 className="text-2xl font-bold mb-5">
              ...
              Cache Settings</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
              <Button onClick={() => removeSession('receipts')} label="Clear cached receipts" icon={<FontAwesomeIcon icon={faBroom} />} width="auto" />
              <Button onClick={() => removeSession('cards')} label="Clear cached cards" icon={<FontAwesomeIcon icon={faBroom} />} width="auto" />
              <Button onClick={() => removeSession('categories')} label="Clear cached classes" icon={<FontAwesomeIcon icon={faBroom} />} width="auto" />
            </div>
          </div>
