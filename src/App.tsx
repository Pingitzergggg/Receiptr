...
function App() {
  ...
  const Dock = () => {
    ...
    return (
    <div className="dock">
        <button id="receipts" onClick={() => {navigate('/receipts')}} className={location.pathname.includes("/receipts") || location.pathname == "/" ? 'dock-active' : ''}>
        ...
        <button id="cards" onClick={() => {navigate('/cards')}} className={location.pathname.includes("/cards") ? 'dock-active' : ''}>
        ...
        <button id="classes" onClick={() => {navigate('/classes')}} className={location.pathname.includes("/classes") ? 'dock-active' : ''}>
        ...
        <button id="settings" onClick={() => {navigate('/settings')}} className={location.pathname.includes("/settings") ? 'dock-active' : ''}>
